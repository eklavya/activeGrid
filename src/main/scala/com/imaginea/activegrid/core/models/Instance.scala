...
object Instance {
  ...
  def apply(instanceId: Option[String], name: String, state: Option[String], instanceType: Option[String],
            ...
            imageInfo: Option[ImageInfo], sshAccessInfo: Option[SSHAccessInfo]
           ): Instance =
    Instance(None, instanceId, name, state, instanceType, platform, architecture, publicDnsName, launchTime,
      memoryInfo, rootDiskInfo, tags, sshAccessInfo, List.empty[InstanceConnection], List.empty[InstanceConnection],
      Set.empty[ProcessInfo], imageInfo, List.empty[InstanceUser], None, None, None, None, None, None, None, None,
  ...
  def apply(name: String, tags: List[KeyValueInfo], processes: Set[ProcessInfo]): Instance =
    Instance(None, None, name, None, None, None, None, None, None, None, None, tags, None,
      List.empty[InstanceConnection], List.empty[InstanceConnection], processes, None, List.empty[InstanceUser],
  ...
  def apply(name: String): Instance =
    Instance(None, None, name, None, None, None, None, None, None, None, None, List.empty[KeyValueInfo],
      None, List.empty[InstanceConnection], List.empty[InstanceConnection], Set.empty[ProcessInfo],
      None, List.empty[InstanceUser], None, None, None, None, None, None, None, None, List.empty, List.empty, reservedInstance = false, None)
  ...
  def fromNeo4jGraph(nodeId: Long): Option[Instance] = {
    ...
    mayBeNode match {
      case Some(node) =>
        ...
        Some(Instance(Some(nodeId), instanceId, name, state, instanceType, platform, architecture, publicDnsName, Some(launchTime), memoryInfo, rootDiskInfo,
          tags, sshAccessInfo, liveConnections, estimatedConnections, processes, imageInfo, existingUsers,
          None, availabilityZone, privateDnsName, privateIpAddress, publicIpAddress, elasticIP, monitoring, rootDeviceType, blockDeviceMappings,
