...
case object UploadedKeyPair extends KeyPairStatus { val name = "UPLOADED" }
case object NotYetUploadedKeyPair extends KeyPairStatus { val name = "NOT_YET_UPLOADED" }
case object IncorrectUploadKeyPair extends KeyPairStatus { val name = "INCORRECT_UPLOAD" }
