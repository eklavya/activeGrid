...
import com.activegrid.entities.Setting
import com.activegrid.utilities.Connection
...
/**
  ...
  */
trait Neo4jRepository extends Neo4jWrapper with EmbeddedGraphDatabaseServiceProvider {
